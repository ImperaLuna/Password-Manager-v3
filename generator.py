...
class Generator(ctk.CTkToplevel):
    def __init__(self, master):
        ...
        self.generate_button.grid(row=5, column=0, padx=20, pady=(20, 0), sticky="w")
